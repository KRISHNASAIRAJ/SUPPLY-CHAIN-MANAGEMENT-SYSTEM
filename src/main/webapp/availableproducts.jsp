			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="Client.jsp">Dashboard</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="availableproducts.jsp">Available Products</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="orderhistory.jsp">Order History</a></li>
  ...
  <tbody>
	...
	try
	{
		...
		while(rs.next())
		{
			...
			<a href="distributororder.jsp?product=<%=rs.getString("PRODUCTID") %>&quantitys=<%=rs.getString("PRODUCTQUANTITY") %>" style="background-color: none; color: white; padding: 5px 10px; text-decoration: none;"></a>
  <td><a href="placeorder.jsp?product=<%=rs.getString("PRODUCTID") %>" style="background-color: red; color: white; padding: 5px 10px; text-decoration: none;">Buy</a></td>
			<%
		}
	}
	catch(Exception e)
