...
<title>Sales History Distributor</title>
<!-- Favicon-->
...
<nav
	...
	<header class="masthead bg-primary text-white text-center">
		...
		<p class="masthead-subheading font-weight-light mb-0">Sales</p>
		<br>
<style>
  td {
  ...
  <tbody>
    ...
    if (username == null) {
      ...
      try {
        ...
        if (userType != null && userType.toUpperCase().equals("CLIENT")) {
          ...
          out.println("<p>No sales found</p>");
        }
      } catch (Exception e) {
        out.println(e);
      }
